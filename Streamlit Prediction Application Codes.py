...
def main():
    ...
    SatisfactionRating = select('11. How satisfied were you with your degree program and career path? (01 being the lowest rating)', list(map(str, encoding_maps['SatisfactionRating'])))
    StressAnxietyLevel = select('12. How would you rate your stress and anxiety levels during your degree? (01 being the lowest rating)', list(map(str, encoding_maps['StressAnxietyLevel'])))
    PhysicalHealth = select('13. How would you rate your physical health during your degree?', list(map(str, encoding_maps['PhysicalHealth'])))
