...
def main():
    ...
    SatisfactionRating = select('11. How satisfied were you with your degree program and career path?', list(map(str, encoding_maps['SatisfactionRating'])))
    StressAnxietyLevel = select('12. How would you rate your stress and anxiety levels?', list(map(str, encoding_maps['StressAnxietyLevel'])))
